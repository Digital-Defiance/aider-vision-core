...
from aider_vision_core.models import (
...
class TestModels(unittest.TestCase):
    def setUp(self):
        ...
        from aider_vision_core.models import MODEL_SETTINGS
    ...
    @patch("aider_vision_core.models.check_for_dependencies")
    ...
    @patch("aider_vision_core.models.check_pip_install_extra")
    def test_check_for_dependencies_bedrock(self, mock_check_pip):
        ...
        from aider_vision_core.models import check_for_dependencies
    ...
    def test_aider_extra_model_settings(self):
        ...
        test_settings = [
            {
                "name": "aider_vision_core/extra_params",
                "extra_params": {
