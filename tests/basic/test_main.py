...
from aider_vision_core.main import check_gitignore, load_dotenv_files, main, setup_git
from aider_vision_core.utils import GitTemporaryDirectory, IgnorantTemporaryDirectory, make_repo
...
class TestMain(TestCase):
    ...
    @patch("aider_vision_core.repo.GitRepo.get_commit_message", return_value="mock commit message")
    ...
    def test_main_with_git_config_yml(self):
        ...
        with patch("aider_vision_core.coders.Coder.create") as MockCoder:
    ...
    def test_encodings_arg(self):
        ...
        with GitTemporaryDirectory():
            with patch("aider_vision_core.coders.Coder.create") as MockCoder:  # noqa: F841
                with patch("aider_vision_core.main.InputOutput") as MockSend:
    ...
    def test_main_exit_calls_version_check(self):
        with GitTemporaryDirectory():
            with (
                patch("aider_vision_core.main.check_version") as mock_check_version,
                patch("aider_vision_core.main.InputOutput") as mock_input_output,
            ):
                main(["--exit", "--check-update"], input=DummyInput(), output=DummyOutput())
                mock_check_version.assert_called_once()
                mock_input_output.assert_called_once()

    @patch("aider_vision_core.main.InputOutput")
    @patch("aider_vision_core.coders.base_coder.Coder.run")
    ...
    def test_dark_mode_sets_code_theme(self):
        ...
        with patch("aider_vision_core.main.InputOutput") as MockInputOutput:
    ...
    def test_lint_option(self):
        with GitTemporaryDirectory() as git_dir:
            ...
            with patch("aider_vision_core.linter.Linter.lint") as MockLinter:
    ...
    def test_yaml_config_file_loading(self):
        with GitTemporaryDirectory() as git_dir:
            ...
            with (
                ...
                patch("aider_vision_core.coders.Coder.create") as MockCoder,
            ):
    ...
    def test_map_tokens_option(self):
        with GitTemporaryDirectory():
            with patch("aider_vision_core.coders.base_coder.RepoMap") as MockRepoMap:
    ...
    def test_model_metadata_file(self):
        ...
        from aider_vision_core.llm import litellm
    ...
    def test_accepts_settings_warnings(self):
        ...
        with GitTemporaryDirectory():
            ...
            with (
                patch("aider_vision_core.io.InputOutput.tool_warning") as mock_warning,
                patch("aider_vision_core.models.Model.set_thinking_tokens") as mock_set_thinking,
            ):
                main(
                    [
                        "--model",
            ...
            with (
                patch("aider_vision_core.io.InputOutput.tool_warning") as mock_warning,
                patch("aider_vision_core.models.Model.set_reasoning_effort") as mock_set_reasoning,
            ):
                main(
    ...
    @patch("aider_vision_core.models.ModelInfoManager.set_verify_ssl")
    def test_no_verify_ssl_sets_model_info_manager(self, mock_set_verify_ssl):
        with GitTemporaryDirectory():
            ...
            with patch("aider_vision_core.models.Model") as mock_model:
                ...
                with patch("aider_vision_core.models.fuzzy_match_models", return_value=[]):
                    main(
    ...
    def test_resolve_aiderignore_path(self):
        ...
        from aider_vision_core.args import resolve_aiderignore_path
    ...
    def test_default_model_selection(self):
        with GitTemporaryDirectory():
            ...
            with patch("aider_vision_core.onboarding.offer_openrouter_oauth") as mock_offer_oauth:
    ...
    def test_check_model_accepts_settings_flag(self):
        ...
        with GitTemporaryDirectory():
            ...
            with patch("aider_vision_core.models.Model.set_thinking_tokens") as mock_set_thinking:
                main(
                    [
                        "--model",
                        "gpt-4o",
    ...
    def test_list_models_with_direct_resource_patch(self):
        ...
        with GitTemporaryDirectory():
            ...
            with patch("aider_vision_core.main.importlib_resources.files", return_value=mock_files):
                # Capture stdout to check the output
                with patch("sys.stdout", new_callable=StringIO) as mock_stdout:
                    main(
            ...
            with patch("aider_vision_core.models.Model.set_reasoning_effort") as mock_set_reasoning:
                main(
                    [
                        "--model",
                        "gpt-3.5-turbo",
    ...
    def test_model_accepts_settings_attribute(self):
        with GitTemporaryDirectory():
            ...
            with patch("aider_vision_core.models.Model") as MockModel:
