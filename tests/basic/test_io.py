...
from aider_vision_core.io import AutoCompleter, ConfirmGroup, InputOutput
...
class TestInputOutput(unittest.TestCase):
    ...
    def test_get_input_is_a_directory_error(self, mock_input):
        ...
        with patch("aider_vision_core.io.open", side_effect=IsADirectoryError):
...
class TestInputOutputMultilineMode(unittest.TestCase):
    ...
    def test_ensure_hash_prefix(self):
        ...
        from aider_vision_core.io import ensure_hash_prefix
...
@patch("aider_vision_core.io.is_dumb_terminal", return_value=False)
...
class TestInputOutputFormatFiles(unittest.TestCase):
    ...
    @patch("aider_vision_core.io.Columns")
