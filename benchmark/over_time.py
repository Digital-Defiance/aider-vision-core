...
class BenchmarkPlotter:
    ...
    def save_and_display(self, fig: plt.Figure):
        plt.savefig("aider_vision_core/website/assets/models-over-time.png")
        plt.savefig("aider_vision_core/website/assets/models-over-time.svg")
        imgcat(fig)
...
def main():
    ...
    models = plotter.load_data("aider_vision_core/website/_data/edit_leaderboard.yml")
    ...
    plotter.plot("aider_vision_core/website/_data/edit_leaderboard.yml")
