...
from aider_vision_core import models, prompts, voice
from aider_vision_core.editor import pipe_editor
from aider_vision_core.format_settings import format_settings
from aider_vision_core.help import Help, install_help_extra
from aider_vision_core.io import CommandCompletionException
from aider_vision_core.llm import litellm
from aider_vision_core.git_undo import undo_last_aider_commit_for_coder
from aider_vision_core.git_workspace import primary_head_from_snapshot
from aider_vision_core.repo import ANY_GIT_ERROR
from aider_vision_core.run_cmd import run_cmd
from aider_vision_core.scrape import Scraper, install_playwright
from aider_vision_core.utils import is_image_file
...
class Commands:
    ...
    def cmd_chat_mode(self, args):
        ...
        from aider_vision_core import coders
    ...
    def raw_cmd_undo(self, args):
        return undo_last_aider_commit_for_coder(self.coder, self.io)
    ...
    def raw_cmd_diff(self, args=""):
        ...
        if len(self.coder.commit_before_message) < 2:
            ...
            commit_before_message = primary_head_from_snapshot(
                self.coder.commit_before_message[-2], self.coder.repo.root
            )
...
"""
    ...
    def cmd_report(self, args):
        ...
        from aider_vision_core.report import report_github_issue
