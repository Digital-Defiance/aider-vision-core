...
from aider_vision_core import __version__, models, urls, utils
from aider_vision_core.analytics import Analytics
from aider_vision_core.args import get_parser
from aider_vision_core.coders import Coder
from aider_vision_core.coders.base_coder import UnknownEditFormat
from aider_vision_core.commands import Commands, SwitchCoder
from aider_vision_core.copypaste import ClipboardWatcher
from aider_vision_core.deprecated import handle_deprecated_model_args
from aider_vision_core.format_settings import format_settings, scrub_sensitive_info
from aider_vision_core.history import ChatSummary
from aider_vision_core.io import InputOutput
from aider_vision_core.llm import litellm  # noqa: F401; properly init litellm on launch
from aider_vision_core.models import ModelSettings
from aider_vision_core.onboarding import offer_openrouter_oauth, select_default_model
from aider_vision_core.git_workspace import create_git_workspace
from aider_vision_core.repo import ANY_GIT_ERROR, GitRepo
from aider_vision_core.report import report_uncaught_exceptions
from aider_vision_core.versioncheck import check_version, install_from_main_branch, install_upgrade
from aider_vision_core.watch import FileWatcher
...
def guessed_wrong_repo(io, git_root, fnames, git_dname):
    ...
    from aider_vision_core.git_workspace import _resolve_workspace_root

    workspace_root = _resolve_workspace_root(fnames, git_dname)
    try:
        if workspace_root:
            check_repo = Path(workspace_root).resolve()
        else:
...
def launch_gui(args):
    ...
    from aider_vision_core import gui
