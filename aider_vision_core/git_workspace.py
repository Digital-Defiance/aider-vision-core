...
from aider_vision_core.git_undo import undo_commit_in_repo
...
class RepoSet:
    ...
    def __init__(self, io, primary: GitRepo, submodule_paths: list[str], **git_repo_kwargs):
        ...
        self.aider_ignore_file = primary.aider_ignore_file
    ...
    def refresh_aider_ignore(self):
        self.primary.refresh_aider_ignore()
