...
from aider_vision_core.main import main as cli_main
from aider_vision_core.scrape import Scraper, has_playwright
...
def search(text=None):
    results = []
    for root, _, files in os.walk("aider_vision_core"):
        for file in files:
