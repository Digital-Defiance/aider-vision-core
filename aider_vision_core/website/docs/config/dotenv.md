...
can also
[download from GitHub](https://github.com/Aider-AI/aider/blob/main/aider_vision_core/website/assets/sample.env).

<!--[[[cog
from aider_vision_core.args import get_sample_dotenv
from pathlib import Path
text=get_sample_dotenv()
Path("aider_vision_core/website/assets/sample.env").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
