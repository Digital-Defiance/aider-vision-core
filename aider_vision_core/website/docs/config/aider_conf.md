...
can also
[download from GitHub](https://github.com/Aider-AI/aider/blob/main/aider_vision_core/website/assets/sample.aider.conf.yml).

<!--[[[cog
from aider_vision_core.args import get_sample_yaml
from pathlib import Path
text=get_sample_yaml()
Path("aider_vision_core/website/assets/sample.aider.conf.yml").write_text(text)
cog.outl("```")
cog.out(text)
cog.outl("```")
]]]-->
