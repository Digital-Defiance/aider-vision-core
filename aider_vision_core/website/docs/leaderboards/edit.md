...
[benchmark results data files](https://github.com/Aider-AI/aider/blob/main/aider_vision_core/website/_data/).
...
files = [
    ...
    'aider_vision_core/website/_data/edit_leaderboard.yml',
]
