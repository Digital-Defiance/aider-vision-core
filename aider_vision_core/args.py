...
from aider_vision_core.args_formatter import (
    DotEnvFormatter,
    MarkdownHelpFormatter,
    YamlHelpFormatter,
)
from aider_vision_core.deprecated import add_deprecated_model_args
...
def get_parser(default_config_files, git_root):
    ...
    from aider_vision_core import coders as _aider_coders
    ...
    if command == "md":
        ...
        if len(sys.argv) > 2:
            ...
            if shell not in shtab.SUPPORTED_SHELLS:
                ...
                sys.exit(1)
            parser = get_parser([], None)
            parser.prog = "aider-vision-core"  # Set the program name on the parser
