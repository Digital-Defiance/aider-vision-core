...
def main():
    ...
    from aider_vision_core import __version__ as current_version
    ...
    with open("aider_vision_core/__init__.py", "r") as f:
        content = f.read()
    ...
    if not dry_run:
        with open("aider_vision_core/__init__.py", "w") as f:
            f.write(updated_content)

    git_commands = [
        ["git", "add", "aider_vision_core/__init__.py"],
    ...
    # Remove aider_vision_core/_version.py if it exists
    version_file = "aider_vision_core/_version.py"
