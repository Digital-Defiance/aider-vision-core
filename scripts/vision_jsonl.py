...
Each output line is a JSON event from :class:`aider_vision_core.event_io.EventIO` and
:class:`aider_vision_core.session.Session`.
...
from aider_vision_core.session import Session  # noqa: E402
